...
| [Dimension Update Fixer](https://modrinth.com/mod/dimension-update-fixer) | Unknown | Fixes the issue where removing a dimension from a world deletes all other dimensions. | Kneelawk | Server | none |
